<h1 style="color:rgb(193,149,207); text-align: center;">
📄 Planeación del Proyecto</h1>
<h3 style="text-align: center">Integrantes: Valentina Galeano Orozco (valenOrozco)</h3>

---

## 1. Objetivo

<p>El objetivo de este proyecto es diseñar y desarrollar una plataforma web que permita monitorear el estado emocional y mental de mujeres jóvenes en contextos vulnerables, utilizando herramientas de análisis de datos con Python. La plataforma busca identificar patrones de riesgo, generar alertas tempranas y ofrecer recursos de apoyo dirigidos específicamente a ellas, contribuyendo al cuidado de su bienestar y la prevención de situaciones críticas relacionadas con la salud mental.</p>
...
En la primera entrega se desarrollarán las siguientes funcionalidades:

- Registro de usuarias: permitir guardar información básica como nombre, edad y correo electrónico.
- Encuestas periódicas: Recopilación de datos simples.
